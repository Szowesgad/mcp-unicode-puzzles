...
const TOOLS = [
  {
    name: "create_puzzle",
    description:
      "Create a new Unicode steganography puzzle with quantum-themed patterns",
    inputSchema: {
      type: "object",
      properties: {
        template: {
  ...
  },
  {
    name: "decode_puzzle",
    description:
      "Decode a Unicode steganography puzzle to reveal hidden messages",
    inputSchema: {
      type: "object",
      properties: {
        encodedText: {
  ...
  },
  {
    name: "search_unicode",
    description:
      "Search for Unicode characters by name, category, or properties",
    inputSchema: {
      type: "object",
      properties: {
        query: {
  ...
  },
  {
    ...
    description:
      "Get a list of zero-width Unicode characters for steganography",
    inputSchema: {
      type: "object",
      properties: {},
    },
