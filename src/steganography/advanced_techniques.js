export class AdvancedUnicodeTechniques {
  constructor() {
    ...
    this.homoglyphs = {
      'a': ['а', 'ɑ', 'α', '𝐚', '𝑎', '𝒂', '𝒶', '𝓪', '𝔞', '𝕒', '𝖆', '𝖺', '𝗮', '𝘢', '𝙖', '𝚊'],
      'b': ['Ь', 'ƅ', 'ḃ', 'ḅ', 'ḇ', '𝐛', '𝑏', '𝒃', '𝒷', '𝓫', '𝔟', '𝕓', '𝖇', '𝖻', '𝗯', '𝘣', '𝙗', '𝚋'],
      'c': ['с', 'ϲ', 'ⅽ', 'ⲥ', '𝐜', '𝑐', '𝒄', '𝒸', '𝓬', '𝔠', '𝕔', '𝖈', '𝖼', '𝗰', '𝘤', '𝙘', '𝚌'],
      'd': ['ԁ', 'ɗ', 'ḋ', 'ḍ', 'ḏ', 'ḑ', 'ḓ', '𝐝', '𝑑', '𝒅', '𝒹', '𝓭', '𝔡', '𝕕', '𝖉', '𝖽', '𝗱', '𝘥', '𝙙', '𝚍'],
      'e': ['е', 'ё', 'ℯ', 'ⅇ', 'ẹ', 'ẻ', 'ẽ', 'ế', 'ề', '𝐞', '𝑒', '𝒆', '𝓮', '𝔢', '𝕖', '𝖊', '𝖾', '𝗲', '𝘦', '𝙚', '𝚎'],
      'f': ['ƒ', 'ḟ', '𝐟', '𝑓', '𝒇', '𝒻', '𝓯', '𝔣', '𝕗', '𝖋', '𝖿', '𝗳', '𝘧', '𝙛', '𝚏'],
      'g': ['ɡ', 'ġ', 'ģ', 'ḡ', 'ǧ', 'ǵ', '𝐠', '𝑔', '𝒈', '𝓰', '𝔤', '𝕘', '𝖌', '𝗀', '𝗴', '𝘨', '𝙜', '𝚐'],
      'h': ['һ', 'ℎ', 'ḣ', 'ḥ', 'ḧ', 'ḩ', 'ḫ', '𝐡', '𝒉', '𝒽', '𝓱', '𝔥', '𝕙', '𝖍', '𝗁', '𝗵', '𝘩', '𝙝', '𝚑'],
      'i': ['і', 'í', 'ì', 'ï', 'ı', 'ɩ', 'ɪ', 'ⅰ', 'ℹ', '𝐢', '𝑖', '𝒊', '𝒾', '𝓲', '𝔦', '𝕚', '𝖎', '𝗂', '𝗶', '𝘪', '𝙞', '𝚒'],
      'j': ['ј', 'ϳ', 'ⅉ', '𝐣', '𝑗', '𝒋', '𝒿', '𝓳', '𝔧', '𝕛', '𝖏', '𝗃', '𝗷', '𝘫', '𝙟', '𝚓'],
      'k': ['κ', 'ķ', 'ḱ', 'ḳ', 'ḵ', 'ⲕ', '𝐤', '𝑘', '𝒌', '𝓀', '𝓴', '𝔨', '𝕜', '𝖐', '𝗄', '𝗸', '𝘬', '𝙠', '𝚔'],
      'l': ['ӏ', 'ℓ', 'ḷ', 'ḹ', 'ḻ', 'ḽ', 'ⅼ', '𝐥', '𝑙', '𝒍', '𝓁', '𝓵', '𝔩', '𝕝', '𝖑', '𝗅', '𝗹', '𝘭', '𝙡', '𝚕'],
      'm': ['м', 'ⅿ', 'ṁ', 'ṃ', 'ⲙ', '𝐦', '𝑚', '𝒎', '𝓂', '𝓶', '𝔪', '𝕞', '𝖒', '𝗆', '𝗺', '𝘮', '𝙢', '𝚖'],
      'n': ['ո', 'ռ', 'ṅ', 'ṇ', 'ṉ', 'ṋ', 'ⲛ', '𝐧', '𝑛', '𝒏', '𝓃', '𝓷', '𝔫', '𝕟', '𝖓', '𝗇', '𝗻', '𝘯', '𝙣', '𝚗'],
      'o': ['о', 'ο', 'օ', 'ℴ', 'ọ', 'ỏ', 'ố', 'ồ', 'ⲟ', '𝐨', '𝑜', '𝒐', '𝓸', '𝔬', '𝕠', '𝖔', '𝗈', '𝗼', '𝘰', '𝙤', '𝚘'],
      'p': ['р', 'ρ', 'ⲣ', 'ṕ', 'ṗ', '𝐩', '𝑝', '𝒑', '𝓅', '𝓹', '𝔭', '𝕡', '𝖕', '𝗉', '𝗽', '𝘱', '𝙥', '𝚙'],
      'q': ['ԛ', 'գ', '𝐪', '𝑞', '𝒒', '𝓆', '𝓺', '𝔮', '𝕢', '𝖖', '𝗊', '𝗾', '𝘲', '𝙦', '𝚚'],
      'r': ['г', 'ṙ', 'ṛ', 'ṝ', 'ṟ', 'ⲅ', '𝐫', '𝑟', '𝒓', '𝓇', '𝓻', '𝔯', '𝕣', '𝖗', '𝗋', '𝗿', '𝘳', '𝙧', '𝚛'],
      's': ['ѕ', 'ś', 'ṡ', 'ṣ', 'ⲥ', '𝐬', '𝑠', '𝒔', '𝓈', '𝓼', '𝔰', '𝕤', '𝖘', '𝗌', '𝘀', '𝘴', '𝙨', '𝚜'],
      't': ['τ', 'ṫ', 'ṭ', 'ṯ', 'ṱ', 'ⲧ', '𝐭', '𝑡', '𝒕', '𝓉', '𝓽', '𝔱', '𝕥', '𝖙', '𝗍', '𝘁', '𝘵', '𝙩', '𝚝'],
      'u': ['υ', 'ս', 'ủ', 'ụ', 'ṳ', 'ṵ', 'ṷ', '𝐮', '𝑢', '𝒖', '𝓊', '𝓾', '𝔲', '𝕦', '𝖚', '𝗎', '𝘂', '𝘶', '𝙪', '𝚞'],
      'v': ['ν', 'ѵ', 'ṽ', 'ṿ', 'ⅴ', 'ⲩ', '𝐯', '𝑣', '𝒗', '𝓋', '𝓿', '𝔳', '𝕧', '𝖛', '𝗏', '𝘃', '𝘷', '𝙫', '𝚟'],
      'w': ['ԝ', 'ẁ', 'ẃ', 'ẅ', 'ẇ', 'ẉ', 'ⱳ', '𝐰', '𝑤', '𝒘', '𝓌', '𝔀', '𝔴', '𝕨', '𝖜', '𝗐', '𝘄', '𝘸', '𝙬', '𝚠'],
      'x': ['х', 'ҳ', 'ẋ', 'ẍ', 'ⅹ', '𝐱', '𝑥', '𝒙', '𝓍', '𝔁', '𝔵', '𝕩', '𝖝', '𝗑', '𝘅', '𝘹', '𝙭', '𝚡'],
      'y': ['у', 'ү', 'ẏ', 'ỳ', 'ỵ', 'ỷ', 'ỹ', 'ⲩ', '𝐲', '𝑦', '𝒚', '𝓎', '𝔂', '𝔶', '𝕪', '𝖞', '𝗒', '𝘆', '𝘺', '𝙮', '𝚢'],
      'z': ['ᴢ', 'ż', 'ẓ', 'ẕ', 'ⱬ', 'ⲍ', '𝐳', '𝑧', '𝒛', '𝓏', '𝔃', '𝔷', '𝕫', '𝖟', '𝗓', '𝘇', '𝘻', '𝙯', '𝚣'],
      // Uppercase
      'A': ['А', 'Α', 'Ａ', 'Ꭺ', 'ᴀ', '𝐀', '𝐴', '𝑨', '𝒜', '𝓐', '𝔄', '𝔸', '𝕬', '𝖠', '𝗔', '𝘈', '𝘼', '𝙰'],
      'B': ['В', 'Β', 'ᴃ', 'ᴮ', 'ℬ', 'Ᏼ', '𝐁', '𝐵', '𝑩', '𝓑', '𝔅', '𝔹', '𝕭', '𝖡', '𝗕', '𝘉', '𝘽', '𝙱'],
      'C': ['С', 'Ϲ', 'Ⅽ', 'ℂ', 'ℭ', 'Ꮯ', '𝐂', '𝐶', '𝑪', '𝒞', '𝓒', '𝔆', '𝕮', '𝖢', '𝗖', '𝘊', '𝘾', '𝙲'],
      'E': ['Е', 'Ε', 'Ꭼ', 'ℰ', 'ℇ', '𝐄', '𝐸', '𝑬', '𝓔', '𝔈', '𝔼', '𝕰', '𝖤', '𝗘', '𝘌', '𝙀', '𝙴'],
      'H': ['Н', 'Η', 'ℋ', 'ℌ', 'ℍ', 'Ꮋ', '𝐇', '𝐻', '𝑯', '𝓗', '𝔋', '𝕳', '𝖧', '𝗛', '𝘏', '𝙃', '𝙷'],
      'I': ['І', 'Ι', 'Ⅰ', 'ℐ', 'ℑ', 'Ꮖ', '𝐈', '𝐼', '𝑰', '𝓘', '𝔌', '𝕀', '𝕴', '𝖨', '𝗜', '𝘐', '𝙄', '𝙸'],
      'M': ['М', 'Μ', 'Ⅿ', 'ℳ', 'Ꮇ', '𝐌', '𝑀', '𝑴', '𝓜', '𝔐', '𝕄', '𝕸', '𝖬', '𝗠', '𝘔', '𝙈', '𝙼'],
      'N': ['Ν', 'ℕ', 'Ꮑ', '𝐍', '𝑁', '𝑵', '𝒩', '𝓝', '𝔑', '𝕹', '𝖭', '𝗡', '𝘕', '𝙉', '𝙽'],
      'O': ['О', 'Ο', 'ⅇ', '𝐎', '𝑂', '𝑶', '𝒪', '𝓞', '𝔒', '𝕆', '𝕺', '𝖮', '𝗢', '𝘖', '𝙊', '𝙾'],
      'P': ['Р', 'Ρ', 'ℙ', 'Ꮲ', '𝐏', '𝑃', '𝑷', '𝒫', '𝓟', '𝔓', '𝕻', '𝖯', '𝗣', '𝘗', '𝙋', '𝙿'],
      'S': ['Ѕ', 'Ꮪ', '𝐒', '𝑆', '𝑺', '𝒮', '𝓢', '𝔖', '𝕊', '𝕾', '𝖲', '𝗦', '𝘚', '𝙎', '𝚂'],
      'T': ['Т', 'Τ', '⊤', 'Ꭲ', '𝐓', '𝑇', '𝑻', '𝒯', '𝓣', '𝔗', '𝕋', '𝕿', '𝖳', '𝗧', '𝘛', '𝙏', '𝚃'],
      'X': ['Х', 'Χ', 'ⅹ', 'Ꭓ', '𝐗', '𝑋', '𝑿', '𝒳', '𝓧', '𝔛', '𝕏', '𝖃', '𝖷', '𝗫', '𝘟', '𝙓', '𝚇'],
      'Y': ['У', 'Υ', 'Ⲩ', 'Ꭹ', 'Ү', '𝐘', '𝑌', '𝒀', '𝒴', '𝓨', '𝔜', '𝕐', '𝖄', '𝖸', '𝗬', '𝘠', '𝙔', '𝚈'],
      ' ': [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', '　'] // Various space characters
    };

    // COMBINING MARKS - znaki diakrytyczne do "chaosu"
    this.combiningMarks = {
      above: ['̀', '́', '̂', '̃', '̄', '̅', '̆', '̇', '̈', '̉', '̊', '̋', '̌', '̍', '̎', '̏', '̐', '̑', '̒', '̓', '̔', '̽', '̾', '̿', '̀', '́', '͂', '̓', '̈́', '͊', '͋', '͌', '̃', '̂', '̌', '͐', '̀', '́', '̋', '̏', '̒', '̓', '̔', '̽', '̉', 'ͅ', '͆', '̚'],
      ...
      enclosing: ['⃝', '⃞', '⃟', '⃠', '⃢', '⃣', '⃤', '⃥', '⃦', '⃧', '⃨', '⃩', '⃪', '⃫', '⃬', '⃭', '⃮', '⃯', '⃰']
    };
    ...
    this.variationSelectors = {
      VS1: '\uFE00',   VS2: '\uFE01',   VS3: '\uFE02',   VS4: '\uFE03',
      VS5: '\uFE04',   VS6: '\uFE05',   VS7: '\uFE06',   VS8: '\uFE07',
      VS9: '\uFE08',   VS10: '\uFE09',  VS11: '\uFE0A',  VS12: '\uFE0B',
      VS13: '\uFE0C',  VS14: '\uFE0D',  VS15: '\uFE0E',  VS16: '\uFE0F'
    };
  }
  ...
  bidirectionalEncode(text, secret) {
    ...
    for (let word of words) {
      if (secretIndex < secretBinary.length && secretBinary[secretIndex] === '1') {
  ...
  whitespaceEncode(text, secret) {
    ...
    for (let i = 0; i < text.length; i++) {
      ...
      if (text[i] === ' ' && secretIndex + 3 < secretBinary.length) {
        ...
        encoded = encoded.slice(0, -1) + (spaceMap[fourBits] || this.whitespaces.SPACE);
        secretIndex += 4;
      }
    }
